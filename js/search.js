if (typeof (jQuery) != 'undefined') {
    ...
    $(window).unload(function () {
        if (!resultOrPagingClicked) {
            if (typeof (_gaq) != 'undefined') _gaq.push(['_trackEvent', 'search-results', "none clicked"]);
        }
    });
    ...
    $(function () {
        ...
        $(".article dt a").click(function () {
            ...
            if (typeof (_gaq) != 'undefined') _gaq.push(['_trackEvent', 'search-results', positionClicked.toString(), this.className]);
